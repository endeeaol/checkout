...
{block name='page_content_container' prepend}
	<section id="content-hook_order_confirmation">
		<div class="card-block row justify-content-center mt-5">


			<div class="wire_order col-12 col-lg-8 text-center">
				<img src="{$urls.theme_assets}img/icon-heart.svg" alt="Thank You">
				<h3 class="text-center colorsuccess mt-2">{l s='Thank you for your order!' d='Shop.Theme.Checkout'}</h3>

				<p class="text-center">{l s='You will shortly receive an email asking you to confirm it.' d='Shop.Theme.Checkout'}</p>
			...
			{hook h='displayOrderConfirmationMy'}
